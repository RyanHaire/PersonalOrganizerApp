...
namespace PersonalOrganizerApp.Controllers
{
    public class ReminderController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DateTime,Description")] Reminder reminder)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DateTime,Description")] Reminder reminder)
        {
            if (id != reminder.Id)
            {
                return NotFound();
